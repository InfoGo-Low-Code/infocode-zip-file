...
export async function createExcelVersoes<K extends keyof QueryResultMap>(
  data: WithoutID<QueryResultMap[K]>[],
) {
  const workbook = new Workbook()
  const worksheet = workbook.addWorksheet('VERSÕES DISPONÍVEIS')
  ...
  titleCell.value = `RELATÓRIO DE PRODUTOS COM VERSÕES DISPONÍVEIS`
