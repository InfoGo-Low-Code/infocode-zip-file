...
export async function createExcelTrocaCodigo<K extends keyof QueryResultMap>(
  data: WithoutID<QueryResultMap[K]>[],
) {
  const workbook = new Workbook()
  const worksheet = workbook.addWorksheet('MUDANÇA DE CÓDIGOS')
  ...
  titleCell.value = `RELATÓRIO DE PRODUTOS COM MUDANÇA DE CÓDIGOS`
